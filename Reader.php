...
/* Hardcoded the required items since we do not use composer here. */
require_once(JPATH_SITE.'/modules/mod_jgeoipfilter/Reader/Decoder.php');
require_once(JPATH_SITE.'/modules/mod_jgeoipfilter/Reader/InvalidDatabaseException.php');
require_once(JPATH_SITE.'/modules/mod_jgeoipfilter/Reader/Metadata.php');
require_once(JPATH_SITE.'/modules/mod_jgeoipfilter/Reader/Util.php');
